      ...
      <div className="w-full space-y-4 sm:space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
          ...
          <input
            ...
            className={`w-full px-4 py-3 bg-transparent border ${!isValidEmail && email ? "border-red-500" : "border-gray-700"} rounded-full text-white text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-[#459ddc]`}
          />
          <input
            type="password"
            ...
            className={`w-full px-4 py-3 bg-transparent border ${!isValidPassword && password ? "border-red-500" : "border-gray-700"} rounded-full text-white text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-[#459ddc]`}
          />
          {!isLogin && (
            <input
              type="password"
              ...
              className={`w-full px-4 py-3  bg-transparent border ${!isConfirmMatch && confirmPassword ? "border-red-500" : "border-gray-700"} rounded-full text-white text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-[#459ddc]`}
            />
          )}
          <Button 
            type="submit" 
