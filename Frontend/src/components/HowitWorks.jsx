...
const HowitWorks = () => {
  return (
    <div className='pt-44'>
      ...
      <div>
        <div className="ml-4 sm:ml-10 lg:ml-20 space-y-16 px-4 sm:px-6 mt-6 py-12 text-neutral-800">
          {/* Step 1 */}
          <div className="space-y-4">
            <p className="text-sm text-neutral-400">01</p>
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-white">Upload</h2>
            <p className="text-sm sm:text-base lg:text-lg text-neutral-500 max-w-md">
          ...
          <div className="space-y-4">
            ...
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-white">Ask Anything</h2>
            <p className="text-sm sm:text-base lg:text-lg text-neutral-500 max-w-md">
          ...
          <div className="space-y-4">
            ...
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-white">Get Answers + Audio Snippets</h2>
            <p className="text-sm sm:text-base lg:text-lg text-neutral-500 max-w-md">
